...
import com.ecommerce.order.domain.order.exception.OrderCannotBeModifiedException;
import com.ecommerce.order.domain.order.exception.PaidPriceNotSameWithOrderPriceException;
import com.ecommerce.order.domain.order.exception.ProductNotInOrderException;
...
import static com.ecommerce.order.domain.order.model.OrderStatus.CREATED;
import static com.ecommerce.order.domain.order.model.OrderStatus.PAID;
